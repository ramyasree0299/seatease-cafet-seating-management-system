...
ap.add_argument("-v", "--video", type=str, default="./media/cafet_1.mp4",
...
# python3 real_time_object_detection.py --prototxt MobileNetSSD_deploy.prototxt.txt --model MobileNetSSD_deploy.caffemodel --video ./media/cafet_2.mp4
# python3 flask.py
# /usr/local/mysql/bin/mysql -uroot -p
# python real_time_object_detection.py --prototxt MobileNetSSD_deploy.prototxt.txt --model MobileNetSSD_deploy.caffemodel --video ./media/cafet_2.mp4
# python flask.py
